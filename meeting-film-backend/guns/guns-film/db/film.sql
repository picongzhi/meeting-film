...
-- ----------------------------
INSERT INTO banner(banner_address, banner_url)
...
-- ----------------------------
DROP TABLE IF EXISTS `cat_dict`;
CREATE TABLE cat_dict
(
  UUID      INT PRIMARY KEY AUTO_INCREMENT COMMENT '主键编号',
...
-- ----------------------------
INSERT INTO cat_dict(uuid, show_name)
values (99, '全部');
INSERT INTO cat_dict(uuid, show_name)
values (1, '爱情');
INSERT INTO cat_dict(uuid, show_name)
...
-- ----------------------------
INSERT INTO source_dict(uuid, show_name)
values (99, '全部');
INSERT INTO source_dict(uuid, show_name)
values (1, '大陆');
INSERT INTO source_dict(uuid, show_name)
...
-- ----------------------------
INSERT INTO year_dict(uuid, show_name)
values (99, '全部');
INSERT INTO year_dict(uuid, show_name)
values (1, '更早');
INSERT INTO year_dict(uuid, show_name)
...
-- ----------------------------
INSERT INTO film(uuid, film_name, film_source, film_type, film_cats, film_area, film_date, film_time,
...
-- ----------------------------
INSERT INTO film_info(film_id, film_en_name, film_score, film_score_num, film_length, director_id, film_imgs,
                      biography)
...
-- ----------------------------
INSERT INTO actor(uuid, actor_name, actor_img) value (1, '徐峥', 'actors/2b98c9d2e6d23a7eff25dcac8b584b0136045.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (2, '王传君', 'actors/b782d497577baffb5ed14de52841dcb164365.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (3, '谭卓', 'actors/acf7db57456cb1aed1a42f7ebffedaa842002.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (4, '黄渤', 'actors/c6594ef2705dcaf7d9df857d228b5e1645712.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (5, '舒淇', 'actors/6b32a489467283bb739a2bac3b2b929742175.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (6, '张艺兴', 'actors/b738d5e78a1f5c3379d9d42a9b18286f32246.jpeg');
INSERT INTO actor(uuid, actor_name, actor_img) value (7, '强森', 'actors/7e3067d066c1e285b0cc17bfd5f1b34e108474.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (8, '杰森·斯坦森', 'actors/7ec0c90aec03c7904c1db3af1153162f77864.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (9, '李冰冰', 'actors/d2258cd0529950cf5099206519d91d0e51803.jpg');
INSERT INTO actor(uuid, actor_name, actor_img) value (10, '汤姆·克鲁斯', 'actors/6afaea1cb4ca2b346e86e265347c78b833970.jpg');