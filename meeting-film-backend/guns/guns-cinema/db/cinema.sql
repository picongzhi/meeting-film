...
-- ----------------------------
INSERT INTO brand_dict(UUID, show_name)
VALUES (99, '全部');
INSERT INTO brand_dict(UUID, show_name)
VALUES (1, '大地影院');
INSERT INTO brand_dict(UUID, show_name)
...
-- ----------------------------
INSERT INTO area_dict(UUID, show_name)
VALUES (99, '全部');
INSERT INTO area_dict(UUID, show_name)
VALUES (1, '朝阳区');
INSERT INTO area_dict(UUID, show_name)
...
-- ----------------------------
INSERT INTO hall_dict(UUID, show_name)
VALUES (99, '全部');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (1, 'IMAX厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (2, 'CGS中国巨幕厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (3, '杜比全景声厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (4, 'Dolby Cinema厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (5, 'RealD厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (6, 'RealD 6FL厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (7, 'LUXE巨幕厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (8, '4DX厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (9, 'DTS:X 临境音厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (10, '儿童厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (11, '4K厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (12, '4D厅', 'seats/123214.json');
INSERT INTO hall_dict(UUID, show_name, seat_address)
VALUES (13, '巨幕厅', 'seats/123214.json');
...
-- ----------------------------
INSERT INTO cinema(UUID, cinema_name, brand_id, area_id, cinema_address, minimum_price, img_address,
                   cinema_phone, hall_ids)
...
INSERT INTO cinema(UUID, cinema_name, brand_id, area_id, cinema_address, minimum_price, img_address,
                   cinema_phone, hall_ids)
VALUES (4, '万达影院(奥体中心店)', 2, 4, "北京市朝阳区奥林匹克公园新奥购物中心", 60, '/cinemas/44374823__5777386.jpg', '010-58391231',
        '#1#3#5#6#');
INSERT INTO cinema(UUID, cinema_name, brand_id, area_id, cinema_address, minimum_price, img_address,
                   cinema_phone, hall_ids)
...
-- ----------------------------
INSERT INTO field(UUID, cinema_id, film_id, begin_time, end_time, hall_id, hall_name, price)
...
-- ----------------------------
INSERT INTO hall_film_info(UUID, film_id, film_name, film_length, film_cats, actors, film_language, img_address)
